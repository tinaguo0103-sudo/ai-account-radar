...
其中 `selection_reason` 和 `unique_judgment` 必须是这张候选卡自己的实质判断：指出来源里的具体事实或细节、受影响的人或动作、会带来的后果，以及 Austin 在这里要承担的取舍。不要只把标题换一种说法，也不要用“值得关注”“适合账号”之类的口号代替判断。自由成文即可，不新增小节、顺序、长度、清单或评分要求。
