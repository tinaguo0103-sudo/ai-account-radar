...
class NaturalRunContinuationTest(unittest.TestCase):
    ...
    def test_release_contract_keeps_one_automation_and_forbids_nested_runtime(self):
        ...
        self.assertEqual(schedule["existingId"], "ai-git")
        ...
        self.assertIn("does not add wakeups", protocol)
        self.assertIn("article_required", protocol)
        self.assertIn("spoken_adaptation_required", protocol)
        self.assertIn("--article-item-file", protocol)
        self.assertIn("--script-item-file", protocol)
