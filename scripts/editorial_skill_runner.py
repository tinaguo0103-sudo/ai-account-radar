...
HUMAN_TITLE_PATTERNS = [
    (
        ...
        "我会把这篇Brief流程，改成自己的AI选题验收方式",
    ),
    (
        ("小云雀", "Seedance", "短剧Agent"),
        "我会把小云雀这次更新，放进AI短片交付流程里验证",
    ),
    (
        ("Vercel", "Eve", "每个智能体就是一个文件目录"),
        "Vercel Eve对我有用，不是因为它叫Agent，而是它把项目经验变成可验收目录",
    ),
    (
        ("Omnigent", "AI智能体团队元框架"),
        "我会把Omnigent改成一个问题：多Agent协作怎么进入真实执行台？",
    ),
    (
        ("Claude Design", "品牌一致", "封面Skill"),
        "Claude Design这次更新，我会先拿来验证封面Skill能不能少掉一轮返工",
    ),
    (
        ("MOSS-TTS", "SGLang-Omni", "48 kHz", "配音"),
        "MOSS-TTS对我有用，不是因为像真人，而是它能不能进入成片节奏",
    ),
    (
        ("Kickart", "广告视频", "车企素材"),
        "Kickart 3.0对我有用，要看它能不能进入品牌广告视频交付流程",
    ),
    (
        ("豆包", "Excel", "表格"),
        "豆包表格对我有用的地方，是能不能承接我的选题判断",
    ),
    (
        ("baoyu-design", "动画视频导出", "交付QA"),
        "baoyu-design本地导出后，我真正关心的是它能不能进入商业交付链路",
    ),
]
