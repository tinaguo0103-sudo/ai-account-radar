...
def positioning_hypothesis_rows() -> list[dict[str, Any]]:
    return [
        ...
        {
            "模块": "内容生成边界",
            "假设内容": "采集和选题阶段只生成命题卡，不直接生成完整小红书文案、公众号文章或短视频成稿；已确认选题可由脚本Skill生成口播稿与执行包。",
            "依据来自": "用户明确要求保留个人判断、表达、人设和业务现场感。",
            "为什么这样假设": "账号信任来自你的判断和真实现场，AI可以写可修改草稿，但不能替你最终定稿或发布。",
            "需要验证什么": "口播稿与执行包是否降低启动期琐事，同时不稀释个人表达。",
            "验证信号": "你从选题到拍摄的耗时、发布质量、是否仍有个人判断和真实案例。",
            "如果信号不好怎么调整": "补强制作方向卡、风格Skill、素材清单和事实核验，不让选题阶段提前成稿。",
            "状态": "明确边界",
        },
        {
            "模块": "商业验证假设",
