...
| AR-026 | 飞书 01 全量对标账号采集覆盖 | P1 | RC Self-Validation Passed / Release QA In Progress | dev/test -> RC -> production release | RC 0b5a98e check-only 计划 33 条；生产 01 八条隔离仍待 RC QA 与独立授权 |
...
| AR-026 | 飞书 01 全量对标账号采集覆盖 | P1 | RC Release QA In Progress | release/ar020e-rc-ar026-20260715@0b5a98e | QA 通过后才申请生产 Git、01 八条精确迁移/read-back 与 automation status-only pause/resume |
