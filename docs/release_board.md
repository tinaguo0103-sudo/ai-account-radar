...
| AR-026 | 飞书 01 全量对标账号采集覆盖 | P1 | RC2 Dev Self-Validation Passed / Release QA In Progress | dev/test -> RC -> production release | RC2 5e733cd 三层正 cap pre-side-effect hard fail 已自验；正做完整发布 QA |
...
| AR-026 | 飞书 01 全量对标账号采集覆盖 | P1 | RC2 Release QA In Progress | release/ar020e-rc-ar026-capgate-20260715@5e733cd | 首个 RC 失败历史保留；RC2 全范围 QA 通过后才申请生产授权 |
