...
| AR-026 | 飞书 01 全量对标账号采集覆盖 | P1 | QA Passed / Production-base RC Building | dev/test -> RC -> production release | AR-031 前置已解除；正从 production 178f047 组独立窄 RC，生产 01 八条隔离仍待独立授权 |
...
| AR-026 | 飞书 01 全量对标账号采集覆盖 | P1 | Production-base RC Building | feature/next-production-flow | 基于 production 178f047 建最小 RC；发布时需生产 01 写入授权，将 8 个污染源隔离并 read-back |
